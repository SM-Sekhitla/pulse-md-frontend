    ...
    <AdminShell title="Subscriptions">
      <div className="mb-4 grid gap-4 md:grid-cols-3">
        <div className="pulse-card p-5">
          <div className="label-caps">MRR</div>
          <div className="text-[26px] font-bold text-navy">
            {formatZAR(monthly)}
          </div>
        </div>
        <div className="pulse-card p-5">
          <div className="label-caps">Active subs</div>
          <div className="text-[26px] font-bold text-navy">{active.length}</div>
        </div>
        <div className="pulse-card p-5">
          <div className="label-caps">Avg per practice</div>
          <div className="text-[26px] font-bold text-navy">
            {formatZAR(active.length ? monthly / active.length : 0)}
          </div>
        </div>
      </div>
