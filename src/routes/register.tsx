        ...
        <div className="mt-8 pulse-card p-8">
          {step === 0 && (
            <Section
              ...
              sub="We'll use this to set up your tenant and branding."
            >
              <Grid>
                <Input
                  label="Practice name"
...
function HoursStep() {
  ...
  return (
    <Section
      title="Working hours"
      sub="Set when patients can book appointments."
    >
      <div className="space-y-2">
        {days.map((d, i) => (
          <div
            key={d}
            className="flex items-center gap-4 rounded-md border border-border bg-white px-4 py-2.5"
          >
            ...
            <input
              ...
              defaultValue="08:00"
              disabled={i >= 5}
              className="rounded-md border border-border bg-white px-2 py-1.5 text-[13px]"
            />
...
function BrandingStep() {
  ...
  return (
    <Section
      title="Branding"
      sub="Your accent colour appears on buttons, links, and badges."
    >
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        {colors.map((c, i) => (
          <button
            key={c}
            className={`h-10 w-10 rounded-md border-2 ${i === 0 ? "border-navy" : "border-transparent"}`}
            style={{ background: c }}
          />
        ))}
      </div>
